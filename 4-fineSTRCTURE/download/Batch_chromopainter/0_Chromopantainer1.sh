...
OUTPUT_DIR="${BASE_DIR}/OUTPUT/New_Chunk_1/" # 空文件夹
...
cd "$OUTPUT_DIR"
# 定义输入VCF文件和输出前缀
VCF_FILE="${INPUT_DIR}/Chunk_1.vcf.gz"
...
python3 /home/luolintao/Helicopter/Script/分析结果/fineSTRUCTURE/Script/3_replace_ids.py \
      ...
      /home/luolintao/Helicopter/Script/分析结果/fineSTRUCTURE/OUTPUT/New_Chunk_1/Chunk_1_HP.ids

# 执行 ChromoPainterv2 命令
"${ChromoPainter_SCRIPTS}/ChromoPainterv2" \
    -g "${OUTPUT_DIR}/Chunk_1_HP.phase" \
    -r "${OUTPUT_DIR}/Chunk_1_HP.recombfile" \
    -t "${OUTPUT_DIR}/Chunk_1_HP.ids" \
